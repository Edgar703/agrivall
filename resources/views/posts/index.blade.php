    ...
    <div class="animate-fadeInUp">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex gap-2">
                <button class="btn btn-agrivall-outline d-lg-none" data-bs-toggle="modal" data-bs-target="#postFiltrosModal">
                    Filtros
                </button>
                @auth
                            ...
                            <form action="{{ route('posts.index') }}" method="GET">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="q" class="form-control-agrivall"
                                        value="{{ request('q') }}" placeholder="Título, contenido o autor">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="categoria" class="form-control-agrivall">
                                        ...
                                        <option value="noticia" {{ request('categoria') == 'noticia' ? 'selected' : '' }}>📰
                                            Noticia</option>
                                        <option value="blog" {{ request('categoria') == 'blog' ? 'selected' : '' }}>✍️
                                            Blog</option>
                                        <option value="evento" {{ request('categoria') == 'evento' ? 'selected' : '' }}>📅
                                            Evento</option>
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-grid gap-2">
                                        <input type="date" name="from" class="form-control-agrivall"
                                            value="{{ request('from') }}">
                                        <input type="date" name="to" class="form-control-agrivall"
                                            value="{{ request('to') }}">
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="preset" class="form-control-agrivall">
                                        ...
                                        <option value="7" {{ request('preset') == '7' ? 'selected' : '' }}>Últimos 7
                                            días</option>
                                        <option value="30" {{ request('preset') == '30' ? 'selected' : '' }}>Últimos 30
                                            días</option>
                                        <option value="90" {{ request('preset') == '90' ? 'selected' : '' }}>Últimos 90
                                            días</option>
                                    </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="img-zoom" style="height: 100%; min-height: 250px;">
                                            <img src="{{ asset('storage/' . $post->imagen) }}"
                                                class="img-fluid h-100 w-100" alt="{{ $post->titulo }}"
                ...
                <form action="{{ route('posts.index') }}" method="GET" class="js-filter-modal-form">
                    <div class="modal-body p-4">
                        <div class="mb-3">
                            <label class="form-label-agrivall">Buscar</label>
                            <input type="text" name="q" class="form-control-agrivall"
                                value="{{ request('q') }}" placeholder="Titulo, contenido o autor">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="categoria" class="form-control-agrivall">
                                ...
                                <option value="noticia" {{ request('categoria') == 'noticia' ? 'selected' : '' }}>📰
                                    Noticia</option>
                                <option value="blog" {{ request('categoria') == 'blog' ? 'selected' : '' }}>✍️ Blog
                                </option>
                                <option value="evento" {{ request('categoria') == 'evento' ? 'selected' : '' }}>📅 Evento
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="preset" class="form-control-agrivall">
                                <option value="">Sin filtro</option>
                                <option value="7" {{ request('preset') == '7' ? 'selected' : '' }}>Ultimos 7 dias
                                </option>
                                <option value="30" {{ request('preset') == '30' ? 'selected' : '' }}>Ultimos 30 dias
                                </option>
                                <option value="90" {{ request('preset') == '90' ? 'selected' : '' }}>Ultimos 90 dias
                                </option>
                            </select>
                            <small class="text-muted">Si eliges rango, tiene prioridad.</small>
                        </div>
