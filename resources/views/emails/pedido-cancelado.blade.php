...
<head>
    ...
    <style>
        ...
        .header { background-color: #7f1d1d; color: white; padding: 20px; border-radius: 8px 8px 0 0; text-align: center; }
        ...
        .label { font-weight: bold; color: #7f1d1d; font-size: 0.9em; text-transform: uppercase; margin-bottom: 5px; }
        ...
        th { background-color: #f8eeee; color: #7f1d1d; font-size: 0.85em; text-transform: uppercase; }
        .total-row td { font-weight: bold; color: #7f1d1d; border-top: 2px solid #7f1d1d; }
...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="footer"><p>Este correo se ha generado automaticamente desde la web de Agrivall.</p></div>
        </div>
    </div>
</body>
</html>
