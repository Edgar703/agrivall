                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex flex-column">
                                                    <span class="fw-medium">{{ $reserva->fecha_inicio->format('d/m/Y') }}</span>
                                                    <span class="text-muted small">hasta {{ $reserva->fecha_fin->format('d/m/Y') }}</span>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <span class="badge bg-light text-dark">{{ $reserva->num_personas }} {{ $reserva->num_personas > 1 ? 'personas' : 'persona' }}</span>
                                            </td>
                            ...
                            <div class="row g-3">
                                <div class="col-md-4">
                                    <div class="text-center p-3 bg-light rounded">
                                        <div class="h4 mb-1 text-green fw-bold">{{ $reservas->where('estado', 'confirmada')->count() }}</div>
                                        <div class="small text-muted">Reservas Confirmadas</div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="text-center p-3 bg-light rounded">
                                        <div class="h4 mb-1 text-warning fw-bold">{{ $reservas->where('estado', 'pendiente')->count() }}</div>
                                        <div class="small text-muted">Reservas Pendientes</div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="text-center p-3 bg-light rounded">
                                        <div class="h4 mb-1 text-green fw-bold">${{ number_format($reservas->where('estado', '!=', 'cancelada')->sum('precio_total'), 2) }}</div>
        ...
        <div class="mt-4">
            <div class="card border-danger">
                <div class="card-body p-4">
                    ...
                    <p class="text-muted small mb-3">Una vez eliminada tu cuenta, todos los datos se perderán permanentemente.</p>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="text-muted">¿Estás seguro de que deseas eliminar tu cuenta? Todos tus datos y reservas se eliminarán permanentemente. Esta acción no se puede deshacer.</p>
